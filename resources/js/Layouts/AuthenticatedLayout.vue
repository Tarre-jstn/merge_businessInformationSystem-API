...
<template>
  <div class="flex h-screen overflow-hidden">
    <Sidebar v-if="!isSmallScreen" class="flex-shrink-0" />

    <div class="flex flex-col flex-grow overflow-hidden">
      <nav class="bg-white border-b border-gray-100 flex-shrink-0">
        <!-- Primary Navigation Menu -->
        <div class="border-b border-gray-700 max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex items-center">
              <h2 class="font-semibold text-xl text-black dark:text-black leading-tight">Information System</h2>
            </div>
      ...
      <div class="flex-grow overflow-auto bg-white">
        ...
        <!-- Page Content -->
        <main class="h-full flex-grow p-6 bg-white">
          <slot />
        </main>
      </div>
    </div>
