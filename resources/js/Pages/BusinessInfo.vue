...
if (
    ...
    !business.value.facebook ||
    !business.value.x ||
    !business.value.instagram ||
    !business.value.tiktok
) {
...
data() {
    return {
        // Predefined provinces, cities, and barangays in Luzon
        provinces: ['Bulacan', 'Pampanga', 'Tarlac'], // Add more provinces as needed
        citiesByProvince: {
...
methods: {
    filterCities() {
        ...
        this.filteredCities = this.citiesByProvince[this.selectedProvince] || [];
    },
    filterBarangays() {
        // Reset barangay when city changes
        this.business.barangay = '';

        // Filter barangays based on the selected city
        this.filteredBarangays = this.barangaysByCity[this.selectedCity] || [];
    },
},
};
</script>
