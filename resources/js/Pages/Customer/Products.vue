...
function showMore(){
    next.value=true;
    if(!length.value>=9){
        alert("There are only ${length.value} to be displayed");
    }else{
    getWebsiteInfo();
    }
}
...
<div class=" mt-8 mx-auto my-auto flex flex-wrap justify-center gap-4 w-full max-w-screen-lg mt-[10px] px-4 pt-[200px]">
    ...
    <!-- card 1 -->
        <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            <img :src="`/storage/products/${textAreas.card1_img}`" class="w-full h-3/5 object-cover"/>
            <p class="text-black text-[18px] mt-[10px] text-center">{{textAreas.card1}}</p>
            <p class="text-black text-[18px]">{{textAreas.card1_desc}}</p>
        </div>
     ...
     <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card2_desc}}</p>
        </div>
    ...
    <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card3_desc}}</p>
        </div>
    </div>
    ...
    <!-- card 4 -->
    <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            <img :src="`/storage/products/${textAreas.card4_img}`" class="w-full h-3/5 object-cover"/>
            <p class="text-black text-[18px] mt-[10px] text-center">{{textAreas.card4}}</p>
            <p class="text-black text-[18px]">{{textAreas.card4_desc}}</p>
        </div>
    ...
    <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card5_desc}}</p>
        </div>
    ...
    <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card6_desc}}</p>
        </div> 
    </div>
    ...
    <div class="block flex flex-row gap-9">
        ...
        <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card7_desc}}</p>
        </div> 
        ...
        <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card8_desc}}</p>
        </div> 
        ...
        <div class="flex flex-col bg-white w-[340px] h-[360px] p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <p class="text-black text-[18px]">{{textAreas.card9_desc}}</p>
        </div> 
