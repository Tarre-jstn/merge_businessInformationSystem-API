...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //THIS DATABASE TABLE FOLLOWS RECEIPT PRINTING FORMAT 
            ...
            $table->enum('status', ['paid', 'partially paid', 'unpaid']); //if receipt is paid, unpaid, or partially paid.

            $table->string('authorized_Representative')->nullable(); //cashier or authorized representative: EMPLOYEE THAT MADE THE INVOICE.
            $table->enum('payment_Type', ['cash','check']); //will customer pay through cash or check
        ...
        Schema::create('invoice_items', function (Blueprint $table) {
            ...
            $table->decimal('product_price', 8, 2)->nullable(); // unit price
            ...
            $table->decimal('aCD_price')->nullable(); //price of additional price/services
